...
Private Sub cmdUpdate_Click()
   ...
   If lIncluir Then
      ...
      lIncluir = False
   Else
      gSql = "UPDATE  tb_clientes SET Nome = '" & Me.txtNome.Text & "',"
...
Private Sub Abre_Le_rst()
   ...
   End If
   sConectaLocal
   gSql = "select id,cpf_cnpj,nome,email,celular,endereco,bairro,cidade,estado,cep"
   gSql = gSql & " FROM tb_clientes"
